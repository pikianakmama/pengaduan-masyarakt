      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <h4 class="text-dark font-weight-normal">Aplikasi <span class="font-weight-bold">Pengaduan Masyarakat</span></h4>
        ...
        <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="/assets/img/unsplash/login-bg.jpg">
          <div class="absolute-bottom-left index-2">
            ...
            <a class="text-light bb" target="_blank" href="https://unsplash.com/photos/a8lTjWJJgLA"></a><a class="text-light bb" target="_blank" href="https://unsplash.com"></a>
            </div>
          </div>
        </div>
      </div>
